...
def compress_channels_2d(
    ...
    in_comp_data = ifft_to_k(input_data=sampled_data, dims=(0,))
    ...
    for idx_z in iter_bar:
        ...
        uncomp_data = ifft_to_k(input_k_space[:, :, idx_z].to(device), dims=(0,))
    ...
    out_comp_data = fft_to_img(out_comp_data, dims=(0,))
...
def compress_channels_arxv(input_k_space: torch.tensor, sampling_pattern: torch.tensor,
    ...
    if use_gcc_along_read:
        ...
        in_comp_data = ifft_to_k(in_comp_data, dims=(0,))
        ac_data = ifft_to_k(ac_data, dims=(0,))
